        ...
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                <div class="collapse" id="collapseOperation" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('vehiculo.index')}}"> <em class='bx bxs-truck'></em>Vehiculos</a>


                            <a class="nav-link" href="{{route('carga.index')}}"><em class='bx bxs-package'></em>Carga</a>
                            <a class="nav-link" href="{{route('ruta.index')}}"><em class='bx bx-trip'></em>Rutas</a>
                            <a class="nav-link" href="{{route('clienteJuridico.index')}}"> <em class='bx bx-group'></em>clientes</a>
                        </li>
                    </nav>
                </div>
                <li class="nav-item mt-2">

<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
    ...
    <ul class="navbar-nav align-items-center ms-auto">
        ...
        <li class="nav-item dropdown no-caret d-none d-sm-block me-2 dropdown-notifications">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" data-bs-toggle="tooltip"
                data-bs-placement="bottom" id="navbarDropdownMessages" href="javascript:void(0);" role="button"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Configuraciones"><i
                    class='bx bx-cog menu-list2'></i></a>
        ...
        <li class="nav-item dropdown no-caret d-none d-sm-block me-2 dropdown-notifications">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownAlerts"
                ...
                aria-expanded="false" title="Notificaciones"><i class='bx bx-bell menu-list2'></i></a>
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"

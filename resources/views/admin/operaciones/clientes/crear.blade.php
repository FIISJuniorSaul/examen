                ...
                <div class="page-body page-body-light pt-3 px-2">
                    <div class="card card-header-actions">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('clienteNatural.create')}}">{{ __('Natural Client') }}</a>
                            </li>
                        </ul>
                        <main>
                            <!-- Main page content-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-md-5">
                                                    <small id="mensaje" style="color: red;display: none;font-size: 12pt;">
                                                        <i class="fa fa-remove"></i>{{ __(' The RUC number is not valid.') }}
                                                    </small>
                                                </div>
                                                ...
                                                <form action="{{ route('clienteJuridico.store') }}" method="post"
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="small mb-1" for="inputNºDERUC">{{ __('RUC number') }} </label>
                                                            <input class="form-control" id="txtruc" type="text"
                                                                name="ruc" placeholder="" value=""
                                                                readonly />
                                                        </div>
                                                        <!-- Form Group (last name)-->

                                                        <div class="col-md-6">
                                                            <label class="small mb-1" for="inputRazónSocial">{{ __('Business name') }}</label>
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        <!-- Form Group (first name)-->
                                                        <div class="col-md-6">
                                                            <label class="small mb-1" for="inputNameEmpresa">{{ __('State') }}</label>
                                                            <input class="form-control" id="txtgrupo" type="text"
                                                                name="estado" placeholder="" value=""
                                                                readonly />
                                                        </div>
                                                        <!-- Form Group (last name)-->
                                                        <div class="col-md-6">
                                                            <label class="small mb-1" for="inputDirección">{{ __('Address') }}</label>

                                                            <input class="form-control" id="txtdireccion" type="text"
                                                                name="direccion" placeholder="" value=""
                                                                readonly />
                                                        </div>
                                                    </div>
                                                    <!-- Form Row-->
                                                    <div class="row gx-3 mb-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input class="form-control" id="txtdistrito" type="text"
                                                                name="distrito" placeholder="" value=""
                                                                readonly />
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row gx-3 mb-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input class="form-control" name="dni"
                                                                    id="dni_ciudadano" type="text" placeholder="********"
                                                                    readonly />
                                                            </div>
                                                            <!-- Form Group (name)-->
                                                            <div class="col-md-6">
